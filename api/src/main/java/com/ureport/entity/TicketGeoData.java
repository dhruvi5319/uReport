...
public class TicketGeoData {
    ...
    @Column(name = "cluster_id_0")
    private Long clusterId0;

    @Column(name = "cluster_id_1")
    private Long clusterId1;

    @Column(name = "cluster_id_2")
    private Long clusterId2;

    @Column(name = "cluster_id_3")
    private Long clusterId3;

    @Column(name = "cluster_id_4")
    private Long clusterId4;

    @Column(name = "cluster_id_5")
    private Long clusterId5;

    @Column(name = "cluster_id_6")
    private Long clusterId6;
